...
#define ADC_CHN_VOLATGE   ADC1_CH7//0    //PA7/ADC12_IN7		POWER_SET	电源电压检测端口
#define ADC_CHN_RSSI      ADC1_CH10   //PC0/ADC12_IN10	RSSI	接收场强检测端口
#define ADC_CHN_SQ_SET    ADC1_CH11   //PC1/ADC12_IN11	SQ_SET	接收静噪检测端口
#define ADC_CHN_KEY2      ADC1_CH15   //PC5/ADC1_IN15		KEY2_SET	防水耳机端口按键检测端口2(AD)
#define ADC_CHN_KEY1      ADC1_CH8    //PB0/ADC12_IN8		KEY1_SET	防水耳机端口按键检测端口1(AD)
#define ADC_CHN_VOX_SET   ADC1_CH9    //PB1/ADC12_IN9		VOX_SET	声控发射检测端口


/* ADC1 channel definition for this example. */
#define ADC1_SA_NORMAL_CHANNEL      (ADC_CHN_RSSI|ADC_CHN_SQ_SET|ADC_CHN_KEY2 |ADC_CHN_KEY1 |ADC_CHN_VOX_SET )
#define ADC1_SA_AVG_CHANNEL         (ADC_CHN_VOLATGE)
#define ADC1_SA_CHANNEL             (ADC1_SA_NORMAL_CHANNEL | ADC1_SA_AVG_CHANNEL)
#define ADC1_SA_CHANNEL_COUNT       (6u)
...
#define ADC1_SA_CHANNEL_SAMPLE_TIME { 0x30,   0x40,   0x50,     0x60,      0x70,      0x80 }

/* ADC2 channel definition for this example. */
//#define ADC2_SA_NORMAL_CHANNEL      (0)
